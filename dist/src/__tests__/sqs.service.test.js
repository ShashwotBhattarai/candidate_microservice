...
describe("Sqs service", () => {
    ...
    test("sqs error occures", () => __awaiter(void 0, void 0, void 0, function* () {
        //mock all dependencies
        const sqsClientMock = (0, aws_sdk_client_mock_1.mockClient)(client_sqs_1.SQSClient).rejects(new Error("SQS Error"));
        const emailPayload = {
            to: "babudallay@gmail.com",
            subject: "new user created",
            text: "your user has been created",
        ...
        expect(result.message).toBe("error in sendMessageToQueue");
    }));
});
